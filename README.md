...
Appunti, teoria e laboratori pratici per la preparazione alle certificazioni **MTCNA** e **CCNA**.
...
## 🧪 Lab 1: Fondamenti, DHCP e Bridging / Lab 1: Basics, DHCP and Bridging

**Cosa impari / What you learn:**
- Configurazione base di MikroTik RouterOS / Basic MikroTik RouterOS configuration
- Setup di VLAN con bridging / VLAN setup with bridging
- DHCP server e client / DHCP server and client
- Inter-routing tra sedi / Inter-site routing

**Ambiente GNS3 / GNS3 environment:**
- 3 router MikroTik (HQ, BRANCH, EDGE)
- 5 PC virtuali (VPCS)
- Link punto-punto tra sedi / Point-to-point links between sites
...
- GNS3 installato / GNS3 installed
- Accesso al server GNS3 / Access to the GNS3 server
- Nozioni base di networking / Basic networking knowledge
